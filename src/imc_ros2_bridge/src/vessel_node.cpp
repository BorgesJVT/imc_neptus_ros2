...
{
  int bridge_port = 6003;
  int imc_src = 5;
  int imc_id = 31;
  
  rclcpp::init(argc, argv);
  auto node = rclcpp::Node::make_shared("vessel_node",
                                        rclcpp::NodeOptions()
  ...
  ros_to_imc::BridgeServer<std_msgs::msg::Empty, IMC::Heartbeat> heartbeat_vessel(node, imc_handle, "vessel_heartbeat");
  ros_to_imc::BridgeServer<neptus_msgs::msg::EstimatedState, IMC::EstimatedState> estimatedstate_vessel(node, imc_handle, "vessel_estimated_state");
  ros_to_imc::BridgeServer<sensor_msgs::msg::NavSatFix, IMC::GpsFix> gpsfix_vessel(node, imc_handle, "vessel_gps");
